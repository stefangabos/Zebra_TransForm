 ...
 *  @version    2.4.5 (last revision: January 26, 2016)
            ...
            update = function(remove) {
                ...
                elements.each(function() {
                    ...
                    var
                        ...
                        attributes, wrapper, replacement, styles, events, arrow, text, label, event_type, idx;
